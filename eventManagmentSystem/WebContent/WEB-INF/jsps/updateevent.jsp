	...
	<div class="container">
		...
		method="post"
			...
			<div class="form-group">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<select name="isIndoor" id="isIndoor" required>
							<option selected="selected"><c:out value="${event.isIndoor}"></c:out></option>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<select name="eventType" id="eventType" required>
							<option selected="selected"><c:out value="${event.eventType}"></c:out></option>
				...
				<!-- sport field -->
				<c:choose>
					<c:when test="${event.eventType == 'sport'}">
				...
				<!-- technology field -->
				<c:choose>
					<c:when test="${event.eventType == 'technology'}">
				<div class="form-group row" id="technologyDiv">
					...
					<div class="col-xs-10">
						...
						<option selected="selected"><c:out value="${event.category}"></c:out></option>
